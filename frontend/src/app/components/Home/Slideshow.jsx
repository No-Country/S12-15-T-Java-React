      ...
      {controles && (
        <Controles>
          ...
          <Boton onClick={anterior}>
            ...
            <img  onClick={anterior} src="/img/flechai.png" alt="Texto alternativo de la imagen"/> 


          </Boton>
          <Boton type='submit' derecho onClick={siguiente}>
          
            <img  onClick={siguiente} src="/img/flechad.png" alt="Texto alternativo de la imagen"/> 
          </Boton>
        </Controles>
      )}
    </ContenedorPrincipal>
